...
export const TYPE_FIELDS = {
  hotel: {
    esencial: [m('hotel_name', 'Hotel'), m('check_in', 'Check-in', 'date'), m('check_out', 'Check-out', 'date'), m('nights', 'Noches', 'number'), m('room_type', 'Tipo de habitación'), m('num_rooms', '# Habitaciones', 'number'), m('meal_plan', 'Plan de alimentos', 'select', SELECTS.meal_plan)],
    operar: [m('hotel_chain', 'Cadena'), m('hotel_brand', 'Marca'), m('hotel_city', 'Ciudad'), m('reserved_by', 'Reservado por', 'select', SELECTS.reserved_by), m('reservation_number', '# Reserva')],
  },
  vuelo: {
